...
`
  ...
  credit: (
    <span>
      <a href="https://codepen.io/jdillon/pen/qEWOGxm" target="_blank" rel="noopener noreferrer" className="link">Retro futuristic radio buttons with GSAP</a> by <a href="https://codepen.io/jdillon" target="_blank" rel="noopener noreferrer" className="link">Josh Dillon</a>
    </span>
  ),
}
