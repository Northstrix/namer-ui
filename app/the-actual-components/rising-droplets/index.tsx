...
const metadata = {
  usage: `// Path to the "RisingDroplets.tsx" file
...
<div className="bg-base-300 p-8 rounded-lg min-h-[300px] gap-6 flex items-center justify-center relative">
  <button text='Enable/Disable' onClick={toggleLoader} />
...
// Note: The RisingDroplets component accepts the following prop:
// - colors: string[] (required) - An array of three color strings for the droplets.
`,
code: [
  {
    filename: 'RisingDroplets.tsx',
    content: `"use client";
...
`
  ...
  credit: (
    <span>
      <a href="https://codepen.io/chrisgannon/pen/ExjmQOm" target="_blank" rel="noopener noreferrer" className="link">Droplet Loader</a> by <a href="https://codepen.io/chrisgannon" target="_blank" rel="noopener noreferrer" className="link">Chris Gannon</a>
    </span>
  ),
}
