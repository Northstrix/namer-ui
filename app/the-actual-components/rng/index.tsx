...
const metadata = {
  usage: `// Path to the "RNG.tsx" file
...
// - width: string (optional) - The width of the RNG component (default: "300px").
// - height: string (optional) - The height of the RNG component (default: "200px").
