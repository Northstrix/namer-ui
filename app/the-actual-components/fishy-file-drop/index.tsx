...
const handleFilesFromFishyFileDrop = async (files: FileList): Promise<void> => {
  console.log('Files received from FishyFileDrop:');
...
// Note: FishyFileDrop Component Usage
// - onFilesSelected: Callback function that receives a FileList object
// - Don't forget to place the "ChristmasTreesPattern.png" file in the "public" folder of your project
`,
code: [
  {
    filename: 'FishyFileDrop.tsx',
    content: `"use client"
...
`
  ...
  credit: (
    <span>
      <a href="https://codepen.io/ash_creator/pen/GRGZYyV" target="_blank" rel="noopener noreferrer" className="link">深海なボタン</a> by <a href="https://codepen.io/ash_creator" target="_blank" rel="noopener noreferrer" className="link">あしざわ - Webクリエイター</a>
      <br />
      ...
      <br />
      <a>Photo by </a><a href="https://www.pexels.com/@ekaterina-bolovtsova/" target="_blank" rel="noopener noreferrer" className="link">KATRIN BOLOVTSOVA</a> from <a href="https://www.pexels.com/photo/different-sizes-of-christmas-tree-shaped-and-star-shaped-gingerbread-cookies-on-white-background-5702703/" target="_blank" rel="noopener noreferrer" className="link">Pexels</a>
    </span>
  ),
}
