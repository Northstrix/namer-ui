...
const metadata = {
  usage: `// Path to the "FancyNotification.tsx" file
...
// Note: The FancyNotification component accepts the following props:
// - type: 'success' | 'error' (required) - The type of notification to display.
// - message: string (required) - The main message to display in the notification.
// - message1?: string (optional) - An optional secondary message to display.
// - isVisible: boolean (required) - Controls the visibility of the notification.
// - onClose: () => void (required) - Function to call when closing the notification.
// - successMessage?: string (optional) - Custom message for success notifications (default: "Success").
// - errorMessage?: string (optional) - Custom message for error notifications (default: "Error").
`,
code: [
  {
    filename: 'FancyNotification.tsx',
    content: `"use client";
...
`
  ...
  credit: (
    <span>
      <a href="https://codepen.io/juliepark/pen/vjMOKQ" target="_blank" rel="noopener noreferrer" className="link">Daily UI#011 | Flash Message (Error/Success)</a> by <a href="https://codepen.io/juliepark" target="_blank" rel="noopener noreferrer" className="link">Julie Park</a>
      <br />
      <a href="https://codepen.io/ash_creator/pen/zYaPZLB" target="_blank" rel="noopener noreferrer" className="link">すりガラスなプロフィールカード</a> by <a href="https://codepen.io/ash_creator" target="_blank" rel="noopener noreferrer" className="link">あしざわ - Webクリエイタ</a>
      <br />
